// LMAO I JUST COPIED THE WHOLE BEE MOVIE SCRIPT
beeMovieScript = [
...
const versions = {
    ...
    "../../files/webarchive/17_08012024_b8fc587/index.html": {
        "commit": "b8fc587",
        "commitMessage": "testing the new path if its valid in the github page.",
        "date": "08/01/2024",
        "description": ""
    },
    "../../index.html": {
...
let randomAnnouncementTicker;
let currentTickerIndex = 0;

function updateTicker() {
    randomAnnouncementTicker.textContent = beeMovieScript[currentTickerIndex];
    currentTickerIndex++;
    saveLastTickerIndex();
}

function saveLastTickerIndex() {
    localStorage.setItem("lastTickerIndex", currentTickerIndex);
}

function loadLastTickerIndex() {
    currentTickerIndex = localStorage.getItem("lastTickerIndex") ? parseInt(localStorage.getItem("lastTickerIndex")) : 0;
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    randomAnnouncementTicker = document.querySelector(".random-announcement-ticker p");
    if (randomAnnouncementTicker) {
        loadLastTickerIndex();
        updateTicker();
